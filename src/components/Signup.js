...
// import  get_user_connected  frosm "../store/models/user";





// @connect(getLoginUser)
 ...
 class Signup extends Component {
  constructor(props) {
    ...
    // console.log("getting user ", get_user_connected.userEmail);
    ...
    return (
      <div className="heading-signup">
        ...
        <div style={this.inputDiv}>
          ...
          />
          <br />
          <button className="btn" onClick={this.loginSignupHandler.bind(this)}>
            Signup
          </button>
        </div>
      </div>
